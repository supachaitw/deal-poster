...
HOOKS = ['เดี๋ยวนะ! อันนี้ต้องดู', 'ใครหาอยู่ ดูนี่เลย!', 'เดี๋ยวก่อน! ดีลนี้คุ้มมาก',
         ...
         # สาย Gen Z 2569 (คำเดียวต่อประโยค เสียงยังสุภาพ) — user ฟังแล้วตัดสินว่า Azure อ่าน "เทส" เพี้ยนไหม
         'อันนี้เทสมากค่ะ | ดูก่อน', 'ทำถึงในราคานี้ | ต้องดู', 'เริ่ดมากอันนี้ | มาดูกัน']
...
CAT_HOOKS = {
    ...
    'gadget': ['สายแก็ดเจ็ต | ต้องดูอันนี้', 'ใครชอบของไอที | เก็บอันนี้ไว้ก่อน'],
...
NEW_LINES = ['ตอนนี้เหลือแค่ | %sบาท…เองค่ะ', 'แต่ตอนนี้ | เหลือแค่%sบาท…เองค่ะ',
             ...
             'ตอนนี้ | %sบาท…ฉ่ำมากค่ะ', 'เหลือ%sบาท…เองนะ | ชีเสิร์ฟ', '%sบาท…เท่านั้นค่ะตอนนี้']
