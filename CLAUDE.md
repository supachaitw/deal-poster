...
- **ความคืบหน้า 30 ส.ค. 69**: สมัคร Partner Center ด้วย**อีเมลใหม่** (อีเมลเดิม gmail ผูกร้าน TikTok Shop → App developer ถูกล็อก "not available for TikTok Shop sellers") · Partner name **Paiyaa Deals**, region Thailand
  ...
  - ทางออกเดียวตอนนี้: **ยื่น ticket** (ข้อความฉบับสมบูรณ์อยู่ใน session log 30 ส.ค. — ถาม individual developer path / ทะเบียนพาณิชย์บุคคลธรรมดาใช้ได้ไหม / dev mode ก่อน publish) จุดยื่น: หน้าแอป การ์ด "Any publish problems?" → submit a ticket หรืออีเมล partner@tiktokshop.com · แผนสำรอง: จดทะเบียนพาณิชย์บุคคลธรรมดา (~50 บาท) แต่เงื่อนไขเขียนว่าต้องจดเกิน 1 ปี
