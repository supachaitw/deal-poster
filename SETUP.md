...
> มีสำเนาหน้านี้บน Notion ด้วย: **"🔁 ตั้งเครื่องใหม่ — Deal Poster (คู่มือ Claude Code)"**
> (Team Space Home → AI → Claude) สำหรับตอนที่ยังไม่ได้ clone repo — แก้ที่ไหนแล้วให้ sync อีกที่ด้วย

## ประโยคแรกที่บอก Claude Code บนเครื่องใหม่
```
อ่าน CLAUDE.md กับ SETUP.md ใน repo นี้ก่อน แล้วสรุปสถานะระบบให้ฟัง
ว่าตอนนี้แต่ละช่องทางเป็นยังไง มีอะไรค้างอยู่บ้าง
```
